...
options=("Install Docker and Docker Compose" "Install Portainer" "Install Traefik" "Install Guacamole with Local User Authentication" "Install Guacamole with LDAP User Authentication" "Install Zabbix" "Exit")
