...
read -p "Enter a FTP Username you wish to delete: "  FTP_USER

docker exec -it pure-ftpd /usr/bin/pure-pw userdel $FTP_USER -f /etc/pure-ftpd/passwd/pureftpd.passwd -m
